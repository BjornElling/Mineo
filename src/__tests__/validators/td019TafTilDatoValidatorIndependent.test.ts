...
// Fra-datoen gør rækken ikke-tom, mens den manglende til-dato isolerer
// TAF-rækkens completeness-gren.
...
describe('TD-019 – TAF til-dato uden schema-fixture', () => {
  it('rapporterer manglende til-dato med præcis feltsti, besked og severity', () => {
