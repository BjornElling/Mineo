...
| `DATA-001` | Data-/satskatalog, integritet og udvalgte uafhængige endpointfacit gennemgået | 27 filer / 489 målrettede tests; literal-facit for udvalgte perioder, 25 statiske endpoint-/partitionfacitter, 2/2 statiske folkepensions-downstreamfacitter, 1/1 KRL-downstreamfacit, 1/1 Statistik/ILON12-downstreamfacit og 16/16 offentlig KL-løn-tests med konkret komponent-/dagstotalfacit samt sats → beregning → dokument-kæde er grønne. `loenudviklingBeregning.test.ts` har desuden et statisk SBLON2-downstream-facit med 48/48 beståede tests, procesrente-downstreamfacittet bestod 1/1, og sygedagpengebanen har statiske facitter for 2025 samt 2019/2020-satsgrænsen | Resterende kilder, validatorpartitioner og komplet downstream-paritet; `TD-020` | `I gang` |
...
## Seneste DOC-001/TD-019/TD-020-retest efter revisioner `902034ca`, `69d0b53d`, `61b138c8`, `010b44d9`, `890fa37e`, `682b0ba3`, `c41f8391`, `14ce800f`, `1b372144`, `b61ff7b1`, `2c5dc621`, `8028b5ee` og `9517459f`
...
- `loenudviklingBeregning.test.ts` fastholder desuden 2025-sygedagpengernes statiske satsinput,
  ...
  transformationen og ikke juridisk kildekorrekthed.
- Den målrettede direkte kontrol af de ti validatorfacitfiler bestod med 10 filer / 33 tests.
