...
import { createYearTableInputAdapter, type TableYearPolicy, useTableInputCore } from '../../../hooks/tableInput';
...
const TableYearInput = React.memo(
  ({
    ...
    const adapter = React.useMemo(
      () => createYearTableInputAdapter({ minYear, maxYear, twoDigitYearPolicy }),
