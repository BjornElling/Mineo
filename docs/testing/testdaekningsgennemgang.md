...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `PERSIST-002` / arbejdsrevision efter `1cb0b07b` |
...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `CALC-007` / arbejdsrevision efter `e8e319ad` |
