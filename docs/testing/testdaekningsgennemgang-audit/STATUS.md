...
De seneste test-only styrkelser er målrettet retestet: standalone-dokumentparitet med 3/3 på `75d1a956`, pensionsalderens downstream-hændelser med 2/2 på `16ad2251`, validatorens negative fritvalg-procent med 13/13 og forsørgertabets EAL-mindstesats med 1/1 på `4418f502`. De målrettede mapperetests står nu på 29 filer / 280 dokumenttests, 33 filer / 531 data-/sats-/endpointtests og 68 filer / 1.526 form-/schema-/validator-tests. Den samlede releasegate skal genkøres efter auditsporene er committet.
