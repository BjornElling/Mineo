...
// De to aktive perioder overlapper med vilje, så validatorens dataintegritetsgren
// rammes uafhængigt af den eksisterende initial-state.
const INDEPENDENT_OVERLAP_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
...
describe('TD-019 – uafhængigt facit for overlappende svie/smerte-perioder', () => {
  it('rapporterer begge overlappende rækker med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_OVERLAP_VALUES);
