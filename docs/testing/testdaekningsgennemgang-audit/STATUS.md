...
- Seneste test-only batch: UI-008-facittet TD-296; målrettet kontrol 1 ny E2E-test / 3 tests; ingen produktkode, beregningslogik, UI/UX eller persistens ændret. TD-025 blev retestet coverage-nært parallelt med 64/64 grønne tests uden reproduktion, men den mulige Tooltip-årsag er fortsat uforklaret.
...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-296` – test-only facitter dokumenteret; `TD-156` er fortsat åbent |
