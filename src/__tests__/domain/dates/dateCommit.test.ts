...
describe('commitIsoDateFromDraftString', () => {
  ...
  describe('gyldigt dansk datoformat (dd-mm-yyyy) → ISO dato', () => {
    ...
    it('31-12-2024 → 2024-12-31', () => {
      expect(commitIsoDateFromDraftString('31-12-2024')).toBe(toISODateString('2024-12-31'));
    });

    it('15-06-2024 → 2024-06-15', () => {
      expect(commitIsoDateFromDraftString('15-06-2024')).toBe(toISODateString('2024-06-15'));
    });

    it('29-02-2024 (skudår) → 2024-02-29', () => {
      expect(commitIsoDateFromDraftString('29-02-2024')).toBe(toISODateString('2024-02-29'));
    });
  });

  describe('gyldigt ISO format (yyyy-mm-dd) → ISO dato', () => {
    it('2024-01-01 → 2024-01-01', () => {
      expect(commitIsoDateFromDraftString(toISODateString('2024-01-01'))).toBe(toISODateString('2024-01-01'));
    });

    it('2024-12-31 → 2024-12-31', () => {
      expect(commitIsoDateFromDraftString(toISODateString('2024-12-31'))).toBe(toISODateString('2024-12-31'));
    });
  });
