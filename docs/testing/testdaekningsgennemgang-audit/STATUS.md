...
- Evidensrevision: `6bc1269e` for seneste samlede releasegate og målrettede test-only batch; seneste fulde E2E er `71746917`
- Branch: `main`
...
- Seneste test-only batch: PERSIST-/VALID-facitter TD-259–TD-269; målrettet kontrol 11 nye tests / 11 tests; ingen produktkode, beregningslogik, UI/UX eller persistens ændret.
...
Aktuel inventarrevision på `6bc1269e`: `PERSIST-002` omfatter nu også den nye silent-read-,
...
med 1/1 typed range-facit. `CALC-006` omfatter
...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-269` – test-only facitter dokumenteret til og med `6bc1269e`; `TD-156` er fortsat åbent |

## Aktuel evidensdelta – revision `6bc1269e`
