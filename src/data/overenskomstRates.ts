...
export const overenskomster: ReadonlyArray<Overenskomst> = [
  // Bygge-/anlægsoverenskomsten
  {
    ...
    satser: satserFromTable(
      ...
      [
        ...
        ['01-03-2026',            149.90,             0.157,            0.1115,            223.75,            208.35,            200.20,            201.50 ],
        ['01-01-2026',            146.40,             0.147,            0.1115,            223.75,            208.35,            200.20,            201.50 ],
  ...
  // Bygningsoverenskomsten
  {
    ...
    satser: satserFromTable(
      ...
      [
        ...
        ['01-03-2026',            149.65,             0.157,            0.1115,            223.75,            208.35,            200.20,            201.50 ],
        ['01-01-2026',            146.15,             0.147,            0.1115,            223.75,            208.35,            200.20,            201.50 ],
  ...
  // El-overenskomsten
  {
    ...
    satser: satserFromTable(
      ...
      [
        ...
        ['01-03-2027',            146.85,             0.099,              0.0700,            0.1115,            223.75,            208.35,            200.20,            201.50 ],
        ['01-03-2026',            143.35,             0.099,              0.0600,            0.1115,            223.75,            208.35,            200.20,            201.50 ],
        ['01-01-2026',            139.85,             0.099,              0.0500,            0.1115,            223.75,            208.35,            200.20,            201.50 ],
        ...
        ['01-01-2023',            127.10,             0.099,              0.0300,            0.0815,            204.25,            190.75,            185.40,            183.90 ],
        ['01-03-2022',            127.10,             0.099,              0.0300,            0.0815,            201.50,            187.20,            179.60,            179.60 ],
        ['01-01-2022',            124.60,             0.099,              0.0200,            0.0815,            201.50,            187.20,            179.60,            179.60 ],
  ...
  // Industri- og VVS-overenskomsten
  {
    ...
    satser: satserFromTable(
      ...
      [
        ...
        ['01-03-2022',            127.15,            0.1350,            0.0800 ],
        ['01-03-2021',            124.65,            0.1250,            0.0800 ],
        ['01-03-2020',            122.15,            0.1150,            0.0800 ]
      ]
    ),
  },
  ...
  {
    meta: {
      id:               toOverenskomstId('mejeribranchens-overenskomst'),
      navn:             'Mejeribranchens Overenskomst',
      loenmodtagerOrg:  ['Dansk Metal', 'Dansk El-Forbund'],
      arbejdsgiverOrg:  ['Dansk Industri'],
      grundloenAngivetPer: 'Time',
      sfggPolicy: {
    ...
    satser: satserFromTable(
      ...
      [
        // fraDato          │ Grundløn         │ SH/SO-sats          │ AG-pens.
        ['01-03-2027',            224.15,            0.1342,            0.1181 ],
        ['01-03-2026',            219.65,            0.1242,            0.1181 ],
        ['01-05-2025',            214.90,            0.1142,            0.1181 ],
        ['01-03-2025',            214.90,            0.1142,            0.1081 ],
        ['01-03-2024',            207.04,            0.1142,            0.1081 ],
        ['01-06-2023',            201.29,            0.0942,            0.1081 ],
        ['01-03-2023',            201.29,            0.0942,            0.0881 ],
        ['01-03-2022',            195.37,            0.0942,            0.0881 ],
        ['01-03-2021',            192.22,            0.0842,            0.0881 ],
        ['01-03-2020',            189.02,            0.0742,            0.0881 ],
        ['01-03-2019',            185.02,            0.0550,            0.0881 ],
        ['01-03-2018',            182.52,            0.0490,            0.0881 ],
        ['01-03-2017',            180.02,            0.0420,            0.0881 ],
  ...
  // Metal-Transport overenskomsten
  {
    ...
    satser: satserFromTable(
      ...
      [
        ...
        ['01-03-2024',            138.70,             0.090,            0.1000 ],
        ['01-06-2023',            134.14,             0.070,            0.1000 ],
        ['01-03-2023',            134.14,             0.070,            0.0800 ],
        ['01-03-2022',            129.60,             0.070,            0.0800 ],
        ['01-03-2021',            127.10,             0.060,            0.0800 ],
        ['01-03-2020',            124.60,             0.050,            0.0800 ],
        ['01-03-2019',            122.10,             0.040,            0.0800 ],
        ['01-03-2018',            120.10,             0.034,            0.0800 ],
        ['01-03-2017',            118.10,             0.027,            0.0800 ],
        ['01-03-2016',            116.10,             0.020,            0.0800 ],
        ['01-03-2015',            114.30,             0.017,            0.0800 ],
        ['01-03-2014',            112.65,             0.013,            0.0800 ]
      ]
    ),
  },
  ...
  {
    meta: {
      id:               toOverenskomstId('vvs-overenskomsten'),
      navn:             'VVS-overenskomsten',
      loenmodtagerOrg:  ['Dansk Metal'],
      arbejdsgiverOrg:  ['Tekniq'],
      grundloenAngivetPer: 'Time',
      sfggPolicy: {
    ...
    satser: satserFromTable(
      ...
      [
        // fraDato          │ Grundløn         │ SH/SO-sats          │ AG-pens.
        ['01-03-2027',            146.85,             0.170,            0.1115 ],
        ['01-03-2026',            143.35,             0.160,            0.1115 ],
        ['01-05-2025',            139.85,             0.150,            0.1115 ],
        ['01-03-2024',            136.10,             0.150,            0.1015 ],
        ['01-06-2023',            131.60,             0.140,            0.1015 ],
        ['01-03-2023',            131.60,             0.140,            0.0815 ],
        ['01-03-2022',            127.10,             0.130,            0.0815 ],
        ['01-03-2021',            124.60,             0.120,            0.0815 ],
        ['01-03-2020',            122.10,             0.110,            0.0815 ],
        ['01-03-2019',            119.60,             0.100,            0.0815 ],
        ['01-03-2018',            117.60,             0.094,            0.0815 ],
        ['01-03-2017',            115.60,             0.087,            0.0815 ],
        ['01-03-2016',            113.60,             0.080,            0.0815 ],
        ['01-03-2015',            111.80,             0.077,            0.0815 ],
        ['01-03-2014',            110.15,             0.073,            0.0815 ]
      ]
    ),
  },
