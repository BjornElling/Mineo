...
// Den negative procentværdi skal nå den samlede canonical-range-validering.
const INDEPENDENT_SH_SO_PCT_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
...
describe('TD-019 – lønindkomstens SH/SO-procent uden schema-fixture', () => {
  it('afviser negativ SH/SO-procent med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_SH_SO_PCT_VALUES);
