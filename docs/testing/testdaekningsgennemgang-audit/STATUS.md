...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-202` – test-only facitter dokumenteret til og med `d3f3c771`; `TD-156` er fortsat åbent |

## Aktuel evidensdelta – revision `d3f3c771`
...
Den seneste arbejdsbatch på `d3f3c771` har grøn målrettet retest og samlet releasegate. Den fulde
