...
| Validatorer og dataendepunkter | Målrettet Vitest-kørsel (se hoveddokumentet) | Bestået | Uafhængige validator-literals, 6 håndskrevne typed schema-runtime-cases, obligatorisk top-level schema-facit, direkte Beregningsperiode-, KRL-, offentlig-løn-, overenskomst- og manuel-lønfacitter, statiske data-/endpointfacitter, 2 folkepensions-downstreamfacitter, 1 KRL-downstreamfacit, 1 Statistik/ILON12-downstreamfacit, 1 procesrente-downstreamfacit samt offentlig-løn-facitter 3/3, overenskomst-facit 1/1 og manuel-løn-facit 1/1 |
...
| `INPUT-002` / `VALID-001` | Form/grid-overflader, produktions-ChoiceField og schema-/validatorhuller gennemgået | 68 filer / 1.524 tests; produktionsbundet form/grid-paritet, 12 nested row-schemas, faktiske `ZodError.issues`, 10 uafhængige validator-literaltests, 6 håndskrevne typed runtime-cases, et obligatorisk top-level schema-facit, direkte Beregningsperiode-lønreguleringsfacit samt selvstændige KRL-, offentlig-løn-, overenskomst- og manuel-lønfacitter er dækket | Yderligere validator-fixture-uafhængighed og downstream-partitioner; `TD-019` | `I gang` |
