...
- Seneste test-only batch: ARCH-003-facittet TD-291; målrettet kontrol 1 ny test / 3 tests i quality-filen; ingen produktkode, beregningslogik, UI/UX eller persistens ændret. TD-025 blev retestet coverage-nært parallelt med 64/64 grønne tests uden reproduktion, men den mulige Tooltip-årsag er fortsat uforklaret.
...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-291` – test-only facitter dokumenteret; `TD-156` er fortsat åbent |
