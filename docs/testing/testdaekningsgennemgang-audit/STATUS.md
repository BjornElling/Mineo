...
- Seneste samlede retest: `verify:release:core` på revision `37a1954d` er grøn med 697 testfiler, 8.755 beståede tests plus 17 forventede `it.fails`; coverage er 90,14 / 81,24 / 93,97 / 92,96, og begge builds bestod. Coveragefasen tog 417,07 s. Den valgte E2E-suite er senest grøn på testrevision `9c965ec5` med 191 beståede tests og 2 forventede skips ud af 193. E2E-kørslen indeholder det nye PDF-artefaktspor, mens de efterfølgende TD-019- og TD-020-ændringer er målrettet retestet på `deec535e`, `5c395772`, `4f4caf24`, `6aa78b27`, `b98fb10c`, `39df52d5`, `c66e09c7`, `1cd38209`, `61b138c8`, `010b44d9`, `890fa37e`, `682b0ba3`, `69d0b53d`, `c41f8391`, `14ce800f`, `1b372144`, `b61ff7b1`, `2c5dc621`, `8028b5ee`, `9517459f`, `9a2bdf45`, `ed3e7ecd`, `ca0b7617`, `c1f7c364`, `4836f1eb`, `01afcc38`, `2c4f9f82`, `ceb14c0b`, `79313191`, `5a952aec`, `8b845383`, `8d5c7a46`, `a5bd7685`, `75d1a956` og `16ad2251`; standalone-renderertesten er målrettet retestet med 3/3 tekstparitet på `75d1a956`, pensionsalderens downstream-facit med 2/2 på `16ad2251`, og EO-række-id-facittet med 14/14 er målrettet retestet på `93021dfa`, og datafacitterne med 148/148 på `37a1954d`. Produktkoden er uændret siden `90c4870f`. Åbne produkt-, proveniens-, outputparitets- og TD-025-stabilitetsfund forhindrer fortsat afslutning.
...
| Aktuel fuld Vitest-retest | `npm run test:coverage` | Bestået | 697 filer, 8.755 tests bestået samt 17 forventede `it.fails`; coverage 90,14 / 81,24 / 93,97 / 92,96; coverage-fase 417,07 s på `37a1954d` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `37a1954d`; coverage 697 filer / 8.755 beståede tests / 17 forventede `it.fails` |
...
| Aktuel coverage-retest | `npm run test:coverage` | Bestået | 393 instrumenterede filer; 90,14 % statements, 81,24 % branches, 93,97 % functions, 92,96 % lines; 18.556 / 20.584, 13.072 / 16.090, 3.024 / 3.218 og 16.948 / 18.230 målte enheder; `coverage/index.html`, `coverage/clover.xml` og `coverage/coverage-final.json`; `37a1954d`, Node `v24.18.0`/Windows |
...
| Dokumentkanalparitet | Målrettet Vitest-kørsel (se hoveddokumentet) | Bestået | 19/19 EET-tabelparitet; `documentPdfArtifactTextParity.test.ts` 1/1; `documentDefinitionFixtureRegistry.test.ts` 66/66 med 18 hovedapp-tekst-, ét hovedapp-billed- og 3 standalone-tekstartefaktforløb; parseren er snæver og fysisk rendering er fortsat åben |
...
| `DOC-001` | Katalog, definitioner, gate/lifecycle og renderer-wiring gennemgået som evidensbaseline for alle registrerede outputs | Fokuseret fixture-/lifecyclekontrol: fixture-registret 66/66 og 2 filer / 23 lifecycle-/coordinator-tests. Samlet dokumentmappe: 29 filer / 280 tests efter faktisk PDF-/Word-artefaktkontrol. `standaloneRenteAlleDocumentDefinition.test.ts` tilføjer 1/1 semantisk renderer-facit, `aarsloenDocumentIndependent.test.ts` tilføjer 1/1 uafhængigt årslønfacit gennem dokumentgeneratoren, og `eetDocumentDefinitionIndependent.test.ts` består med 2/2 EET-definition → Word-facitter. Kataloget dækker 18 Mineo- og 3 standalone-outputs; TD-012 er lukket og TD-013 retestet med udvidet fasebevis | TD-014: manglende generel fysisk rendering og uafhængig PDF/Word-paritet | `I gang` |
...
| `BUILD-001` | Asset-eksistenskontrol, release-graf og PWA-manifestets faktiske filudvalg gennemgået | Syntetisk `verifyBuildArtifacts.test.ts`: 2/2; `releaseGateBuildLiveness.test.ts`: 2/2 med positiv/negativ scriptgraf; `npm run build:mineo` bestået; E2E-buildserver og `eetPageAudit.spec.ts`: 8/8, herunder den ændrede Differencekrav PDF→Word-test med målrettet 1/1 på `1e02e24b`; eksakt produktionsbuilds lokale preview-smoke: 1/1; CI-jobsektionen starter det uploadede produktionsartefakt med fast port, proceskontrol, timeout og cleanup, E2E-matrixen downloader nu det samme artefakt, og statisk artefakt-flow-værn bestod med 6/6; TD-005 lukket | Faktisk GitHub Actions-kørsel og øvrige chunk-/Vite-advarsler mangler; B-002 er delvist dækket | `I gang` |
