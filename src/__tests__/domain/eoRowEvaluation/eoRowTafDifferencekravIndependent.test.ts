...
// TAF slutter 05-01-2024, og et differencekrav gælder fra 06-01-2024.
const INDEPENDENT_DIFFERENCEKRAV_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
  ...
  differencekravDato: iso('2024-01-06'),
...
describe('CALC-006 – uafhængigt TAF-ophørsfacit for differencekrav', () => {
  it('viser differencekrav som ophørsårsag når TAF slutter dagen før kravet', () => {
    const rows = buildEoTaftRows(INDEPENDENT_DIFFERENCEKRAV_VALUES, EMPTY_FIELD_ISSUE_SET, {
      ...
      differencekravDato: INDEPENDENT_DIFFERENCEKRAV_VALUES.differencekravDato,
