...
export const kapitaliseringsId = '9870/2020' as const;
export const kapitaliseringsType = 'vejl' as const;
export const kapitaliseringsFuldeNavn =
  'Vejledning om omsætning foretaget den 31. december 2020 af løbende erstatninger til kapitalbeløb efter lov om arbejdsskadesikring for arbejdsskader indtrådt fra den 1. januar 2011' as const;
export const kapitaliseringsDatering = '01/12/2020' as const;
export const gyldigFra = toISODateString('2020-12-31');
export const gyldigTil = toISODateString('2020-12-31');
// Denne vejledning dækker kun én særskilt kapitaliseringsdato (31-12-2020).
// Datoerne før 31-12-2020 i 2020 dækkes af VEJ 9921/2019.
...
const ERHVERVSEVNETAB_TABELVALG_DATA = [
  ...
  ['2011-01-01',     '1967-01-01',     'A'],
  ['2011-01-01',     '1963-01-01',     'B'],
  ['2011-01-01',     '1955-07-01',     'C'],
] as const;
...
export const erhvervsevnetabTabeller = {
  A: [
    { alder: 5, faktor: 42.988 },
    { alder: 6, faktor: 42.199 },
    { alder: 7, faktor: 41.414 },
    { alder: 8, faktor: 40.632 },
    { alder: 9, faktor: 39.853 },
    { alder: 10, faktor: 39.078 },
    { alder: 11, faktor: 38.307 },
    { alder: 12, faktor: 37.539 },
    { alder: 13, faktor: 36.775 },
    { alder: 14, faktor: 36.014 },
    { alder: 15, faktor: 35.257 },
    { alder: 16, faktor: 34.503 },
    { alder: 17, faktor: 33.753 },
    { alder: 18, faktor: 33.007 },
    { alder: 19, faktor: 32.264 },
    { alder: 20, faktor: 31.525 },
    { alder: 21, faktor: 30.79 },
    { alder: 22, faktor: 30.058 },
    { alder: 23, faktor: 29.33 },
    { alder: 24, faktor: 28.606 },
    { alder: 25, faktor: 27.886 },
    { alder: 26, faktor: 27.17 },
    { alder: 27, faktor: 26.457 },
    { alder: 28, faktor: 25.749 },
    { alder: 29, faktor: 25.044 },
    { alder: 30, faktor: 24.344 },
    { alder: 31, faktor: 23.648 },
    { alder: 32, faktor: 22.955 },
    { alder: 33, faktor: 22.267 },
    { alder: 34, faktor: 21.583 },
    { alder: 35, faktor: 20.904 },
    { alder: 36, faktor: 20.229 },
    { alder: 37, faktor: 19.558 },
    { alder: 38, faktor: 18.891 },
    { alder: 39, faktor: 18.229 },
    { alder: 40, faktor: 17.571 },
    { alder: 41, faktor: 16.918 },
    { alder: 42, faktor: 16.27 },
    { alder: 43, faktor: 15.625 },
    { alder: 44, faktor: 14.986 },
    { alder: 45, faktor: 14.351 },
    { alder: 46, faktor: 13.721 },
    { alder: 47, faktor: 13.095 },
    { alder: 48, faktor: 12.474 },
    { alder: 49, faktor: 11.858 },
    { alder: 50, faktor: 11.245 },
    { alder: 51, faktor: 10.638 },
    { alder: 52, faktor: 10.034 },
    { alder: 53, faktor: 9.435 },
    { alder: 54, faktor: 8.839 },
  ],
  B: [
