...
- Seneste test-only batch: DOC-001/DOC-003-facittet TD-294; målrettet kontrol 1 ny test / 1 test; ingen produktkode, beregningslogik, UI/UX eller persistens ændret. TD-025 blev retestet coverage-nært parallelt med 64/64 grønne tests uden reproduktion, men den mulige Tooltip-årsag er fortsat uforklaret.
...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-294` – test-only facitter dokumenteret; `TD-156` er fortsat åbent |
