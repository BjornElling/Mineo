...
- Evidensrevision: `41bd0b61` for seneste samlede releasegate og målrettede test-only batch; seneste fulde E2E er `71746917`
- Branch: `main`
...
| Aktuel fuld Vitest-retest | `npm run test` | Bestået | 829 filer, 8.988 tests bestået og ingen forventede `it.fails` på `41bd0b61` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `41bd0b61`; coverage 829 filer / 8.988 beståede tests / ingen forventede `it.fails` |
...
| Aktuel coverage-retest | `npm run test:coverage` | Bestået | 394 instrumenterede filer; 90,37 % statements, 81,50 % branches, 94,33 % functions, 93,15 % lines; coverage-artefakterne blev genereret under `coverage/`; `41bd0b61`, Node `v24.18.0`/Windows |
...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-208` – test-only facitter dokumenteret til og med `ef38caa1`; `TD-156` er fortsat åbent |

## Aktuel evidensdelta – revision `ef38caa1`
...
Den seneste arbejdsbatch på `ef38caa1` har grøn målrettet retest og samlet releasegate. Den fulde
