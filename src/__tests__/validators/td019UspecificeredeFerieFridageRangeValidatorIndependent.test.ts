...
// Alle øvrige sektioner er inaktive, så kun den ubetingede canonical daggrænse rammes.
const INDEPENDENT_USPECIFICEREDE_FERIEDAGE_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
  ...
  fravaerPerioder: [],
  uspecificeredeFerieFridage: 367,
...
describe('TD-019 – uspecificerede feriedages canonical grænse uden schema-fixture', () => {
  it('afviser 367 uspecificerede feriedage med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_USPECIFICEREDE_FERIEDAGE_VALUES);
