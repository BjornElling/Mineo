...
// TAF og lønindkomst er inaktive, så den negative værdi isolerer den separate
// canonical-rangegren for EO-angivet løn.
const INDEPENDENT_EO_ANGIVET_LOEN_FERIE_PCT_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
...
describe('TD-019 – EO-angivet løn feriePct uden schema-fixture', () => {
  it('afviser negativ feriePct med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_EO_ANGIVET_LOEN_FERIE_PCT_VALUES);

    expect(result).toEqual({
      isValid: false,
      errors: [{
        path: 'eoAngivetLoenLoenudvikling.feriePct',
