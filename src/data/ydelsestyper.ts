...
/**
 * De supplerende posteringer – dem under stregen. Feriepenge, midlertidigt EET, SU og «Andet» er
 * ikke offentlige ydelser i egen ret, men posteringer, der indgår samme sted i opgørelsen.
 */
const SUPPLERENDE_YDELSESTYPE_KEYS = ['feriepenge', 'midlertidigt_eet', 'su', 'andet'] as const satisfies readonly YdelsestypeKey[];
