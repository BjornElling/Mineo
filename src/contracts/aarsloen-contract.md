...
1. Beregning må kun bruge en `ready` projektion af `aarsloen` og autoriseret `stamdata` fra samme `InputReader`-revision.
...
1. tabelafledninger fra ready, afsluttede rækkeinput,
2. SH-/hverdagsregler,
