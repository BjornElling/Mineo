...
const INDEPENDENT_MANUAL_PERCENT_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
  ...
  eoAngivetLoenLoenudvikling: {
    ...
    loenudviklingManuelProcentsatsTableData: [
      ...
      { id: 'active', dato: toISODateString('2025-01-01'), procent: undefined },
    ],
...
describe('TD-019 – manuel procentsats-validator med aktiv TAF', () => {
  it('rapporterer manglende procent med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_MANUAL_PERCENT_VALUES);

    expect(result).toEqual({
      isValid: false,
      errors: [{
        path: 'eoAngivetLoenLoenudvikling.loenudviklingManuelProcentsatsTableData',
