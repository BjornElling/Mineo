...
export type GreenfieldLoenindkomstViewModelParams = Readonly<{
  eoValues: ErstatningsopgoerelseValues;
  stamdataValues: StamdataValues;
}>;

/** Greenfield EO-lønindkomst: reader-afledt visning og kun typed række-/feltcommands som write-grænse. */
export function useGreenfieldLoenindkomstViewModel({ eoValues, stamdataValues }: GreenfieldLoenindkomstViewModelParams) {
