...
const makeContext = (
  ...
  getLoenindkomstManuelReguleringInputErrors: vi.fn(() => ({} as Readonly<Record<string, true>>)),
  setLoenindkomstManuelReguleringInputError: vi.fn(),
  clearLoenindkomstManuelReguleringInputErrors: vi.fn(),
