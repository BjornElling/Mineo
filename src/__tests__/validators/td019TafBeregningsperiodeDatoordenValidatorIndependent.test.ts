...
// Begge top-level-datoer er udfyldt, men perioden står i omvendt kronologisk orden.
const INDEPENDENT_TAF_BEREGNINGSPERIODE_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
  ...
  tafBeregningsperiodeFra: toISODateString('2024-01-31'),
...
describe('TD-019 – TAF-beregningsperiodens datoorden uden schema-fixture', () => {
  it('rapporterer omvendt top-level-beregningsperiode med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_TAF_BEREGNINGSPERIODE_VALUES);
