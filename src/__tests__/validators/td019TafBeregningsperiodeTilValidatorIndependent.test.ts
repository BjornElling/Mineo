...
// Den udfyldte startdato isolerer den manglende slutdato i TAF-beregningsperioden.
...
describe('TD-019 – TAF-beregningsperiode uden schema-fixture', () => {
  it('rapporterer manglende beregningsperiode-til-dato med præcis feltsti, besked og severity', () => {
