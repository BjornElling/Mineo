...
// Den udfyldte slutdato isolerer den manglende startdato i TAF-beregningsperioden.
...
describe('TD-019 – TAF-beregningsperiode uden schema-fixture', () => {
  it('rapporterer manglende beregningsperiode-fra-dato med præcis feltsti, besked og severity', () => {
