...
// Den manglende månedsløn isolerer beregnesUdFra-branchens krav til Angivet månedsløn.
const INDEPENDENT_TAF_BEREGNES_UD_FRA_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
...
describe('TD-019 – TAF-validatorens beregningskilde uden schema-fixture', () => {
  it('rapporterer manglende månedsløn ved Angivet månedsløn med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_TAF_BEREGNES_UD_FRA_VALUES);
