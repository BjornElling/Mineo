...
| E2E-baner | `npm run test:e2e` | Bestået | 204 beståede tests og 2 forventede skips ud af 206, 4,2 min, 3 workers og 10 projektbaner på `c8187c6d`; den udvidede kørsel omfatter de fire dedikerede browserprojekter |
