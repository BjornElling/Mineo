...
| Baseline: antal kildefiler, testfiler, tests, E2E-specs og mutationsscore | Ved auditstart: 923 produktionsfiler (`.ts/.tsx`), 638 testfiler i alt, 8.421 Vitest-tests, 36 E2E-specs og 174 E2E-tests. Slutnær revision `87b4df72`: 920 produktionsfiler, 660 Vitest-testfiler, 8.586 beståede tests samt 6 forventede `it.fails`, 40 E2E-specs og 179 beståede E2E-tests. Mutationsrunneren er kvalificeret modulvist: money 56/58 dræbt, `dateCommit.ts` 4/6 dræbt, årsløn 108/113 dræbt og varige mén 94/114 dræbt; alle overlevere er triageret. |
| Baseline: `test:coverage`-rapport og de dækkede/udeladte mapper | `coverage/` fra auditrevisionen: 396 instrumenterede filer i `src/domain`, `src/utils`, `src/hooks` og `src/contexts`; den seneste kørsel på `87b4df72` gav 89,21 % statements, 80,45 % branches, 92,35 % functions og 92,01 % lines – 20.584 / 16.090 / 3.218 / 18.230 målte enheder. Coverage-konfigurationen omfatter ikke de øvrige produktionsfiler; de skal klassificeres i inventaret. |
...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `CALC-002` / `87b4df72` |
...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `CALC-004` / `87b4df72` |
...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `CALC-005` / `87b4df72` |
...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `MIN-001` / `87b4df72` |
...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `ARCH-003` / `87b4df72` |
...
- [x] `npm run test:coverage` er kørt på `87b4df72` efter auditens test- og død-kodeændringer og rapporteret med instrumenteret filmængde.
