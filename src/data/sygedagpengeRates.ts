...
export const sygedagpengeRates: readonly DatedSygedagpengeRate[] = [
  { fraDato: iso('2005-01-03'), tilDato: iso('2006-01-01'), sygedagpengePrDagMax: 655, egetAtpPrKalenderuge: 38, kommunaltAtpPrKalenderuge: 76, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2006-01-02'), tilDato: iso('2006-12-31'), sygedagpengePrDagMax: 665, egetAtpPrKalenderuge: 38, kommunaltAtpPrKalenderuge: 76, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2007-01-01'), tilDato: iso('2008-01-06'), sygedagpengePrDagMax: 678, egetAtpPrKalenderuge: 38, kommunaltAtpPrKalenderuge: 76, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2008-01-07'), tilDato: iso('2009-01-04'), sygedagpengePrDagMax: 703, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2009-01-05'), tilDato: iso('2010-01-03'), sygedagpengePrDagMax: 725, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2010-01-04'), tilDato: iso('2011-01-02'), sygedagpengePrDagMax: 738, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2011-01-03'), tilDato: iso('2012-01-01'), sygedagpengePrDagMax: 752, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2012-01-02'), tilDato: iso('2013-01-06'), sygedagpengePrDagMax: 768, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2013-01-07'), tilDato: iso('2014-01-05'), sygedagpengePrDagMax: 788, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2014-01-06'), tilDato: iso('2015-01-04'), sygedagpengePrDagMax: 807, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2015-01-05'), tilDato: iso('2016-01-03'), sygedagpengePrDagMax: 827, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2016-01-04'), tilDato: iso('2017-01-01'), sygedagpengePrDagMax: 836, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2017-01-02'), tilDato: iso('2017-12-31'), sygedagpengePrDagMax: 847, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2018-01-01'), tilDato: iso('2019-01-06'), sygedagpengePrDagMax: 860, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2019-01-07'), tilDato: iso('2020-01-05'), sygedagpengePrDagMax: 875, egetAtpPrKalenderuge: 44, kommunaltAtpPrKalenderuge: 88, obligatoriskPensionProcent: 0 },
  { fraDato: iso('2020-01-06'), tilDato: iso('2021-01-03'), sygedagpengePrDagMax: 881, egetAtpPrKalenderuge: 48, kommunaltAtpPrKalenderuge: 96, obligatoriskPensionProcent: 0.3 },
  { fraDato: iso('2021-01-04'), tilDato: iso('2022-01-02'), sygedagpengePrDagMax: 892, egetAtpPrKalenderuge: 48, kommunaltAtpPrKalenderuge: 96, obligatoriskPensionProcent: 0.6 },
  { fraDato: iso('2022-01-03'), tilDato: iso('2023-01-01'), sygedagpengePrDagMax: 893, egetAtpPrKalenderuge: 48, kommunaltAtpPrKalenderuge: 96, obligatoriskPensionProcent: 0.9 },
  { fraDato: iso('2023-01-02'), tilDato: iso('2023-12-31'), sygedagpengePrDagMax: 910, egetAtpPrKalenderuge: 48, kommunaltAtpPrKalenderuge: 96, obligatoriskPensionProcent: 1.2 },
