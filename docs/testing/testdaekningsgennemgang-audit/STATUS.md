...
- Evidensrevision: `0b4647e2` for seneste samlede releasegate; seneste målrettede test-only batch er `2479fff0`, og seneste fulde E2E er `72a6d44f`
- Branch: `main`
...
- Den fulde Vitest-kørsel bestod med 764 testfiler / 8.854 tests. De tre nye testfacitter er
  test-only; den samlede releasegate skal genkøres efter dokumentationssynkroniseringen.
...
Den seneste målrettede batch på `2479fff0` og den fulde Vitest-suite er retestet grønt. Næste
