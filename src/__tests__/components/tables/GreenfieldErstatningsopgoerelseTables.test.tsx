...
import GreenfieldFerieperiodeTable from '../../../components/tables/GreenfieldFerieperiodeTable';
import GreenfieldOffentligeYdelserTable from '../../../components/tables/GreenfieldOffentligeYdelserTable';
import GreenfieldTafPeriodeTable from '../../../components/tables/GreenfieldTafPeriodeTable';
...
describe('Greenfield-tabeller i Erstatningsopgørelse', () => {
  ...
  it('TAF-tabellen renderer committed rækkefølge og én trailing placeholder', () => {
    ...
    renderInRuntime(
      <GreenfieldTafPeriodeTable committedRows={rows} derivedById={{ 'taf-1': 21 }} derivedColumnHeader="Dage" />
    );
  ...
  it('ferietabellen renderer committed række og afledt antal dage', () => {
    ...
    renderInRuntime(
      <GreenfieldFerieperiodeTable kind="taf" committedRows={rows} feriedageById={{ 'ferie-1': 3 }} />
    );
