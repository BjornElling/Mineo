...
// Den negative værdi skal alene ramme den nested canonical-beløbsissue for manuel SFGG-dagssats.
...
describe('TD-019 – manuel SFGG-dagssats canonical beløbsgrænse uden schema-fixture', () => {
  it('afviser negativ manuel dagssats med præcis nested feltsti, besked og severity', () => {
