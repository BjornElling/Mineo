...
| Baseline: `test:coverage`-rapport og de dækkede/udeladte mapper | `coverage/` fra auditrevisionen: 396 instrumenterede filer i `src/domain`, `src/utils`, `src/hooks` og `src/contexts`; den seneste kørsel på `5c88267f` gav 89,24 % statements, 80,49 % branches, 92,35 % functions og 92,02 % lines – 18.370 / 20.584, 12.951 / 16.090, 2.972 / 3.218 og 16.777 / 18.230 målte enheder. Coverage-konfigurationen omfatter ikke de øvrige produktionsfiler; de skal klassificeres i inventaret. |
...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `ARCH-003` / `e8faa7ce` |
...
- [x] `npm run test:coverage` er kørt på `5c88267f` efter auditens test- og død-kodeændringer og rapporteret med instrumenteret filmængde.
