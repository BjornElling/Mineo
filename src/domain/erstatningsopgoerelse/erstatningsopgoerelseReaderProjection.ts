...
const rebuildEmploymentRow = (
  ...
  return {
    ...
    beregnStoreBededagstillaeg: readOrEmpty(reader, e.beregnStoreBededagstillaeg.bind(employmentId)),
...
const rebuildAngivetLoenLoenudvikling = (reader: InputReader): EOAngivetLoenLoenudvikling => {
  ...
  return {
    ...
    beregnStoreBededagstillaeg: readOrEmpty(reader, a.beregnStoreBededagstillaeg.bind()),
