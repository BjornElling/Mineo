...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-199` – test-only facitter dokumenteret til og med `41bd0b61`; `TD-156` er fortsat åbent |

## Aktuel evidensdelta – revision `41bd0b61`
...
Den seneste samlede releasegate på `41bd0b61` er retestet grønt; den fulde E2E-suite er senest grøn
på `71746917` med 221/223. Den seneste arbejdsbatch tilføjer tre test-only facitter, og både
målrettet retest og samlet releasegate er grønne på `41bd0b61`. Næste arbejdsenhed er en ny
