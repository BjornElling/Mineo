...
- Evidensrevision: `8321fdb2` for seneste samlede releasegate; seneste målrettede test-only batch er `8321fdb2`, og seneste fulde E2E er `8321fdb2`
- Branch: `main`
...
- Seneste samlede retest: `verify:release:core` på revision `8321fdb2` er grøn med 776 testfiler og 8.871 beståede tests uden tilbageværende forventede `it.fails`; coverage er 90,26 / 81,42 / 94,03 / 93,07, og begge builds bestod. Den fulde E2E-suite på revision `8321fdb2` bestod med 214 tests og 2 forventede skips ud af 216 på 10 projektbaner, med 3 workers på 4,8 minutter. TD-003, TD-017 og den konkrete TD-043-afrundingsforskel er lukket; åbne produkt-, proveniens-, outputparitets-, TD-025-stabilitets- og TD-088-modalefund forhindrer fortsat afslutning.
...
| Aktuel fuld Vitest-retest | `npm run test:coverage` | Bestået | 776 filer, 8.871 tests bestået og ingen forventede `it.fails`; coverage 90,26 / 81,42 / 94,03 / 93,07 på `8321fdb2` |
| E2E-baner | `npm run test:e2e` | Bestået | 214 beståede tests og 2 forventede skips ud af 216, 4,8 min, 3 workers og 10 projektbaner på `8321fdb2`; den udvidede kørsel omfatter de fire dedikerede browserprojekter |
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `8321fdb2`; coverage 776 filer / 8.871 beståede tests / ingen forventede `it.fails` |
...
Den seneste målrettede batch og samlede releasegate på `8321fdb2` er retestet grønt; den fulde
E2E-suite er ligeledes grøn på `8321fdb2`. Næste arbejdsenhed er en af de åbne,
