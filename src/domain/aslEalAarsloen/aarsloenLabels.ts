/**
 * Fælles brugervendte navne for de to årslønsfelter.
 *
 * Felterne har én kanonisk værdi hver, selv om de vises på flere sider. Navnene
 * ligger derfor i det delte domæne, så skærm, fejlbeskeder og dokumenter ikke
