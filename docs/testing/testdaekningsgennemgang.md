...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `CALC-005` / `e8faa7ce` |
...
| `CALC-005` | Forsørgertab-engine og snapshot-gates | Håndberegnet ASL/EAL-totalsag med maksimumsbegrænsning | `1.000.000 × 10`, 2013-maksimum `8.432.000`, 30 % EAL og dagbrøk | Håndfacit giver nettokrav `2.158.185` kr.; målrettet flade: 82/82 | Delvist – mutation, browserrejse og dokumentparitet åbne |
