...
// TAF og lønindkomst er inaktive, så værdien 101 isolerer den øvre
// canonical-rangegrænse for EO-angivet løn.
const INDEPENDENT_EO_ANGIVET_LOEN_FERIE_PCT_UPPER_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
...
describe('TD-019 – øvre EO-angivet løn feriePct-grænse uden schema-fixture', () => {
  it('afviser feriePct over 100 med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(
      INDEPENDENT_EO_ANGIVET_LOEN_FERIE_PCT_UPPER_VALUES
    );
