...
- Evidensrevision: `797f1809` for seneste samlede releasegate; seneste målrettede test-only batch er `797f1809`, og seneste fulde E2E er `72a6d44f`
- Branch: `main`
...
| Aktuel fuld Vitest-retest | `npm run test:coverage` | Bestået | 770 filer, 8.860 tests bestået og ingen forventede `it.fails`; coverage 90,26 / 81,41 / 94,03 / 93,07 på `797f1809` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `797f1809`; coverage 770 filer / 8.860 beståede tests / ingen forventede `it.fails` |
...
| Aktuel coverage-retest | `npm run test:coverage` | Bestået | 393 instrumenterede filer; 90,26 % statements, 81,41 % branches, 94,03 % functions, 93,07 % lines; `coverage/index.html`, `coverage/clover.xml` og `coverage/coverage-final.json`; `797f1809`, Node `v24.18.0`/Windows |
