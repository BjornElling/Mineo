...
/**
 * Ren (React-/debug-fri) blokerings-afgørelse for TAF-ferieperiode-rækker (`taf.ferie.*`).
 *
 ...
 * de var hidtil kun håndhævet inde i DEV-debug-builderens display-formattering (jf. B9).
 *
