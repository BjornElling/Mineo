...
// Gyldige periode-datoer gør, at facittet isolerer den nedre canonical grænse
// for løse feriedage fra den separate kontrol af mulige arbejdsdage.
const INDEPENDENT_TAF_LOSE_FERIEDAGE_LOWER_RANGE_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
...
describe('TD-019 – TAF-løse feriedages nedre grænse uden schema-fixture', () => {
  it('afviser negativt antal løse feriedage med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(
      INDEPENDENT_TAF_LOSE_FERIEDAGE_LOWER_RANGE_VALUES,
    );
    ...
    expect(result).toEqual({
      ...
      errors: [{
        ...
        message: 'Antal dage skal være mellem 0 og 999',
        severity: 'error',
      }],
    });
  });
