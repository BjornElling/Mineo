...
- Evidensrevision: `38df665f` for seneste samlede releasegate; seneste målrettede test-only batch er `38df665f`, og seneste fulde E2E er `38df665f`
- Branch: `main`
...
| Aktuel fuld Vitest-retest | `npm run test:coverage` | Bestået | 778 filer, 8.873 tests bestået og ingen forventede `it.fails`; coverage 90,26 / 81,42 / 94,03 / 93,07 på `38df665f` |
