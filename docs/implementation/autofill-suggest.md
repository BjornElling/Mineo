...
>
> **Ét forbehold før implementering:** afsnittet «Ændrede filer» beskriver input-laget fra *før* greenfield.
> `src/components/inputs/table/Table*Input.tsx` findes ikke længere; de nuværende feltkomponenter er
