...
- Evidensrevision: `f7c4edd5` for seneste samlede releasegate og målrettede test-only batch; seneste fulde E2E er `71746917`
- Branch: `main`
...
| Aktuel fuld Vitest-retest | `npm run test:coverage` | Bestået | 916 filer, 9.091 tests bestået og ingen forventede `it.fails` på `f7c4edd5` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `f7c4edd5`; coverage 916 filer / 9.091 beståede tests / ingen forventede `it.fails` |
...
| Aktuel coverage-retest | `npm run test:coverage` | Bestået | 394 instrumenterede filer; 90,74 % statements, 81,99 % branches, 94,88 % functions, 93,54 % lines; 18.705/20.613 statements, 13.204/16.104 branches, 3.063/3.228 funktioner og 17.078/18.257 linjer; coverage-artefakterne blev genereret under `coverage/`; `f7c4edd5`, Node `v24.18.0`/Windows |
