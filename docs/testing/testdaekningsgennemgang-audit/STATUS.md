...
De seneste test-only styrkelser er målrettet retestet: standalone-dokumentparitet med 3/3 på `75d1a956`, pensionsalderens downstream-hændelser med 2/2 på `16ad2251`, validatorens negative fritvalg-procent med 13/13 og forsørgertabets EAL-mindstesats med 1/1 på `4418f502`. Assertion-kvalitetsbatchen på `7281c4cd` bestod med 2 filer / 46 tests og erstattede to generelle truthy/falsy-assertioner med konkrete resultater. Den efterfølgende procesrente-assertion på `f6a61a6a` bestod med 15/15 målrettede tests og kræver nu en ikke-blank række-id. Den samlede releasegate er senest genkørt grønt på `8133fc80` med 697 testfiler / 8.755 beståede tests, 17 forventede `it.fails` og coverage 90,14 / 81,24 / 93,97 / 92,96. Næste arbejdsenhed skal fortsat vælges blandt de åbne, test-only dækningshuller.
