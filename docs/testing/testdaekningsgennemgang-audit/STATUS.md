...
| Aktuel fuld Vitest-retest | `npm run test` | Bestået | 842 filer, 9.004 tests bestået og ingen forventede `it.fails` på `33013239` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `33013239`; coverage 842 filer / 9.004 beståede tests / ingen forventede `it.fails` |
...
| Aktuel coverage-retest | `npm run test:coverage` | Bestået | 394 instrumenterede filer; 90,43 % statements, 81,56 % branches, 94,39 % functions, 93,22 % lines; coverage-artefakterne blev genereret under `coverage/`; `33013239`, Node `v24.18.0`/Windows |
...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-213` – test-only facitter dokumenteret til og med `33013239`; `TD-156` er fortsat åbent |

## Aktuel evidensdelta – revision `33013239`
...
Den seneste arbejdsbatch på `33013239` har grøn målrettet retest og samlet releasegate. Den fulde
