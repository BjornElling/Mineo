...
| Aktuel fuld Vitest-retest | `npm run test:coverage` | Bestået | 718 filer, 8.782 tests bestået samt 17 forventede `it.fails`; coverage 90,23 / 81,37 / 93,97 / 93,04 på `d8a334d7` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `d8a334d7`; coverage 718 filer / 8.782 beståede tests / 17 forventede `it.fails` |
...
| Aktuel coverage-retest | `npm run test:coverage` | Bestået | 393 instrumenterede filer; 90,23 % statements, 81,37 % branches, 93,97 % functions, 93,04 % lines; `coverage/index.html`, `coverage/clover.xml` og `coverage/coverage-final.json`; `d8a334d7`, Node `v24.18.0`/Windows |
...
| Status | Fund |
| --- | --- |
| Lukket | `TD-005`, `TD-006`, `TD-007`, `TD-008`, `TD-009`, `TD-010`, `TD-011`, `TD-012`, `TD-013`, `TD-015`, `TD-021`, `TD-023`, `TD-024`, `TD-035`, `TD-036`, `TD-037`, `TD-038`, `TD-039`, `TD-040`, `TD-041`, `TD-044`, `TD-045`, `TD-046`, `TD-047`, `TD-048`, `TD-049`, `TD-050` |
