...
| Fund-ID'er, beslutninger og opfølgning | Ingen produktfund registreret. Den kontrollerede no-op-modprøve og den uafhængige referencekontrol er bestået som liveness- og krydskontrol-evidens. Åbne auditpunkter: kvalificeret mutationsrunner, komplet testkvalitetsrevision og browser-/adapterparitet. |
