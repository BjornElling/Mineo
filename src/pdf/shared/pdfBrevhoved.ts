 ...
 * - Type-sikker PdfType enum for alle PDF-typer i systemet
 *
 * VIGTIGT:
 ...
 */
export type PdfType = keyof AppSettings['brevhovedIndstillinger'];

/**
 * Ren mapper-funktion: afgør om en given PDF-type skal vise brevhoved
 *
 * EXHAUSTIVENESS-GARANTI:
 * - PdfType er bundet direkte til schema-keys via keyof
 ...
 * generateRentePdf(beloeb, actualInterestDate, beregningsdato, {
 *   visBrevhoved,
 *   stamdata: validatedStamdata
 * });
 * ```
 */
export const getVisBrevhoved = <T extends PdfType>(
