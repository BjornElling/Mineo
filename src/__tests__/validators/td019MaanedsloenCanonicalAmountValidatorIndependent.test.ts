...
// månedslønsværdi isolerer beløbsgrænsen.
const INDEPENDENT_VALUES: ErstatningsopgoerelseValues = {
  ...
  maanedsloenenUdgoer: { kind: 'number', value: -1 },
...
describe('TD-019 – månedslønens canonical beløbsgrænse uden schema-fixture', () => {
  it('afviser negativ månedsløn med præcis feltsti, besked og severity', () => {
