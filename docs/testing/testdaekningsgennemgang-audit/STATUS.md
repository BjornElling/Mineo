...
- Evidensrevision: `4ab724d1` for seneste samlede releasegate og målrettede test-only batch; seneste fulde E2E er `71746917`
- Branch: `main`
...
- Seneste test-only batch: VALID-/DATA-facitter TD-235–TD-236; målrettet kontrol 2 nye tests / 2 tests; ingen produktkode, beregningslogik, UI/UX eller persistens ændret.
...
Aktuel inventarrevision på `f46b1164`: `PERSIST-002` omfatter nu også `fileHandleStorage.persistenceGrant.test.ts`
...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-236` – test-only facitter dokumenteret til og med `4ab724d1`; `TD-156` er fortsat åbent |

## Aktuel evidensdelta – revision `4ab724d1`
