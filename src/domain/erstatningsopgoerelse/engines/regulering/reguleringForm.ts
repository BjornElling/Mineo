...
// docs/review/regulering-arkitektur-redesign.md R1).
// =============================================================================
...
export interface ReguleringForm {
  ...
  /** Trin 2: byg relative deltaPct-segmenter til TAF-beregning. */
  byggSegmenter(konsolideret: KonsolideretLoenudvikling): ReadonlyArray<LoenreguleringsSegment>;
