...
// Perioden har fem mulige arbejdsdage, så seks løse feriedage rammer TAF-branchens
// uafhængige kapacitetskontrol.
const INDEPENDENT_TAF_LOSE_FERIEDAGE_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
...
describe('TD-019 – TAF-validatorens løse feriedage uden schema-fixture', () => {
  it('rapporterer for mange løse feriedage med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_TAF_LOSE_FERIEDAGE_VALUES);
