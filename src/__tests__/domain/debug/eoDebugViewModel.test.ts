...
describe('eoDebugViewModel', () => {
  describe('buildDebugTabelViewModel - Basis funktionalitet', () => {
    ...
    it('genererer korrekt antal rækker', () => {
      const input: DebugModelInput = {
        ...
        erstatningsopgoerelseValues: {
          ...
          vedroererPeriodeTil: '2024-01-05', // 5 dage
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
      };
    ...
    it('getRowKey returnerer ISO-dato', () => {
      ...
      expect(viewModel.getRowKey(0)).toBe('2024-01-01');
      expect(viewModel.getRowKey(1)).toBe('2024-01-02');
      expect(viewModel.getRowKey(2)).toBe('2024-01-03');
    });
    ...
    it('getRowIso returnerer ISO-dato', () => {
      ...
      expect(viewModel.getRowIso(0)).toBe('2024-01-01');
      expect(viewModel.getRowIso(1)).toBe('2024-01-02');
    });
  });
  ...
  describe('buildDebugTabelViewModel - Kolonner', () => {
    ...
    it('tilføjer flere TAF-kolonner i sorteret rækkefølge', () => {
      const input: DebugModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: '2024-01-01',
          vedroererPeriodeTil: '10-01-2024',
          tafPerioder: [
            {
              id: 'taf-3',
              fra: '2024-01-01',
  ...
  describe('buildDebugTabelViewModel - getCell', () => {
    it('returnerer weekday navn', () => {
      const input: DebugModelInput = {
        ...
        erstatningsopgoerelseValues: {
          ...
          vedroererPeriodeTil: '2024-01-02', // Tirsdag
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
      };
    ...
    it('returnerer dato med rawValue og displayValue', () => {
      ...
      if (typeof cell === 'object') {
        expect(cell.rawValue).toBe('2024-01-01');
    ...
    it('returnerer weekend med rawValue og displayValue', () => {
      const input: DebugModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: '2024-01-06', // Lørdag
          vedroererPeriodeTil: '2024-01-08', // Mandag
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
      };
    ...
    it('returnerer søgnehelligdag korrekt', () => {
      const input: DebugModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: '2024-01-01', // Nytårsdag (mandag)
          vedroererPeriodeTil: '2024-01-02',
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
    ...
    it('returnerer arbejdsdag korrekt', () => {
      const input: DebugModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: '2024-01-01', // Nytårsdag (helligdag)
          vedroererPeriodeTil: '2024-01-02', // Tirsdag (arbejdsdag)
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
      };
  ...
  describe('buildDebugTabelViewModel - Options', () => {
    it('filtrerer weekends når includeWeekends=false', () => {
      const input: DebugModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: '2024-01-05', // Fredag
          vedroererPeriodeTil: '2024-01-08', // Mandag
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
