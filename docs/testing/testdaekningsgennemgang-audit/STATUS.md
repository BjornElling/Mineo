...
| Aktuel fuld Vitest-retest | `npm run test:coverage` | Bestået | 729 filer, 8.813 tests bestået og ingen forventede `it.fails`; coverage 90,22 / 81,37 / 93,97 / 93,05 på `4557a98e` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `4557a98e`; coverage 729 filer / 8.813 beståede tests / ingen forventede `it.fails` |
...
| Aktuel coverage-retest | `npm run test:coverage` | Bestået | 393 instrumenterede filer; 90,22 % statements, 81,37 % branches, 93,97 % functions, 93,05 % lines; `coverage/index.html`, `coverage/clover.xml` og `coverage/coverage-final.json`; `4557a98e`, Node `v24.18.0`/Windows |
