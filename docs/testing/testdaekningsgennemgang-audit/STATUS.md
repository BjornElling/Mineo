...
- Evidensrevision: `60fe110f` for seneste samlede releasegate; seneste målrettede test-only batch er `881d285b`, og seneste fulde E2E er `72a6d44f`
- Branch: `main`
...
| Aktuel fuld Vitest-retest | `npm run test:coverage` | Bestået | 764 filer, 8.854 tests bestået og ingen forventede `it.fails`; coverage 90,26 / 81,39 / 94,03 / 93,07 på `60fe110f` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `60fe110f`; coverage 764 filer / 8.854 beståede tests / ingen forventede `it.fails` |
...
| Aktuel coverage-retest | `npm run test:coverage` | Bestået | 393 instrumenterede filer; 90,26 % statements, 81,39 % branches, 94,03 % functions, 93,07 % lines; `coverage/index.html`, `coverage/clover.xml` og `coverage/coverage-final.json`; `60fe110f`, Node `v24.18.0`/Windows |
...
Den seneste målrettede batch på `881d285b` og den fulde Vitest-suite er retestet grønt. Næste
