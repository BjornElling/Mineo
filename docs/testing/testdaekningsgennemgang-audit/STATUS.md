...
| `MIN-001` | Standalone isolation, reset/fokus, error boundary og exit-guard gennemgået | Målrettet E2E 1/1 samt 26-filers shell-/standalonekontrol | Valid input → beregning → gate → PDF og browserbaseret namespace-/runtime-isolation; `TD-023` | `I gang` |
