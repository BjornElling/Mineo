...
| Aktuel fuld Vitest-retest | `npm run test` | Bestået | 784 filer, 8.879 tests bestået og ingen forventede `it.fails` på `9043e591` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `9043e591`; coverage 784 filer / 8.879 beståede tests / ingen forventede `it.fails` |
