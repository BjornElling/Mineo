...
// Den negative sats skal nå den samlede canonical-beløbsvalidering.
const INDEPENDENT_ANCIENNITETSTILLAEG_SATS_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
  ...
  loenindkomstAnsaettelsesforhold: [{
    id: 'af-anciennitetstillaeg-sats',
    ...
    anciennitetstillaegSats: { kind: 'number', value: -1 },
    feriePct: undefined,
...
describe('TD-019 – anciennitetstillægssats uden schema-fixture', () => {
  it('afviser negativ anciennitetstillægssats med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_ANCIENNITETSTILLAEG_SATS_VALUES);

    expect(result).toEqual({
      isValid: false,
      errors: [{
        path: 'loenindkomstAnsaettelsesforhold[0].anciennitetstillaegSats',
