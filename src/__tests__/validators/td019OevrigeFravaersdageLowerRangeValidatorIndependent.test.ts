...
// Alle øvrige sektioner er inaktive, så kun den nedre centrale daggrænse rammes.
const INDEPENDENT_OEVRIGE_FRAVAERSDAGE_LOWER_RANGE_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
  ...
  oevrigeFravaersdageBeskrivelse: 'Uafhængigt nedre grænsefacit',
...
describe('TD-019 – øvrige fraværsdages nedre canonical grænse uden schema-fixture', () => {
  it('afviser negativt antal øvrige fraværsdage med præcis feltsti, besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(
      INDEPENDENT_OEVRIGE_FRAVAERSDAGE_LOWER_RANGE_VALUES,
    );
