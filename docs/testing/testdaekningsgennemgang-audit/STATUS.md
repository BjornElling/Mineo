...
- Evidensrevision: `c49c5714` for seneste samlede releasegate og målrettede test-only batch; seneste fulde E2E er `71746917`
- Branch: `main`
...
- Seneste test-only batch: ARCH-/DOC-facitter TD-233–TD-234; målrettet kontrol 2 nye tests / 2 tests; ingen produktkode, beregningslogik, UI/UX eller persistens ændret.
...
| Senest tilføjet lukket | `TD-153`, `TD-154`, `TD-155`, `TD-157`–`TD-234` – test-only facitter dokumenteret til og med `c49c5714`; `TD-156` er fortsat åbent |

## Aktuel evidensdelta – revision `c49c5714`
