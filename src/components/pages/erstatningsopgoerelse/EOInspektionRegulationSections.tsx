/**
 * EOInspektionRegulationSections - render-only komponent til regulering.
 *
 * Viser regulerings-sektioner fra `RegulationInspektionSection`-view-modellen:
...
import { INSPEKTION_REGULATION_ROW_LABEL_WIDTH as LABEL_WIDTH } from './eoInspektionRowRendering';
 ...
 */
const EOInspektionRegulationSections = React.memo<{
  sections: readonly RegulationInspektionSection[];
}>(({ sections }) => {
...
EOInspektionRegulationSections.displayName = 'EOInspektionRegulationSections';

export default EOInspektionRegulationSections;
