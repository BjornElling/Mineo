...
**Blokerende fejl:** `aarsloen-missing`, `aarsloen-zero`, `eal-aarsloen-zero`, `eet-pct-missing`, `eal-eet-pct-invalid`, `asl-selected-eet-pct-invalid`, `asl-identiske-afgoerelser` (kun ved ASL-fallback), `skadelidte-fodselsdato-missing`, `beregningsdato-missing`, `skadedato-missing`, `reguleringssats-missing`, `eet-max-missing`, `alder-unresolved`.
