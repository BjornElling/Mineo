/**
 * Tests for eoInspektionCoreModel
 */
...
describe('eoInspektionCoreModel', () => {
  describe('buildInspektionCoreModel - Step 1: Tidslinje basis', () => {
    it('returnerer tom array ved tom input', () => {
      ...
      const result = buildInspektionCoreModel(input);
    ...
    it('genererer enkelt dag når start === end', () => {
      ...
      expect(result[0]?.iso).toBe(toISODateString('2024-01-01'));
    });
    ...
    it('sætter weekday korrekt', () => {
      const input: InspektionModelInput = {
        ...
        erstatningsopgoerelseValues: {
          ...
          vedroererPeriodeTil: toISODateString('2024-01-07'), // Søndag
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
      };
  ...
  describe('buildInspektionCoreModel - Step 2: Søgnehelligdage', () => {
    ...
    it('markerer juledag som søgnehelligdag når det er hverdag', () => {
      const input: InspektionModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: toISODateString('2024-12-24'),
          vedroererPeriodeTil: toISODateString('2024-12-26'),
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
      };
      ...
      const juledag = result.find((d) => d.iso === toISODateString('2024-12-25'));
    ...
    it('markerer arbejdsdage korrekt (hverdag OG ikke søgnehelligdag)', () => {
      const input: InspektionModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: toISODateString('2024-01-01'), // Nytårsdag (mandag, men helligdag)
          vedroererPeriodeTil: toISODateString('2024-01-03'), // Onsdag (normal arbejdsdag)
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
      };
  ...
  describe('buildInspektionCoreModel - Step 3: TAF-perioder', () => {
  ...
  describe('buildInspektionCoreModel - Step 4: Svie/smerte', () => {
    ...
    it('mapper tilstand korrekt til niveau', () => {
      const input: InspektionModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: toISODateString('2024-01-01'),
          vedroererPeriodeTil: toISODateString('2024-01-06'),
          tafPerioder: [],
          svieSmertePerioder: [
            {
              id: 'ss-1',
  ...
  describe('buildInspektionCoreModel - Kantscenarier', () => {
    it('håndterer månedsskifte', () => {
      const input: InspektionModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: toISODateString('2024-01-30'),
          vedroererPeriodeTil: toISODateString('2024-02-02'),
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
      };
    ...
    it('håndterer skudår', () => {
      const input: InspektionModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: toISODateString('2024-02-28'),
          vedroererPeriodeTil: toISODateString('2024-03-01'),
          tafPerioder: [],
          svieSmertePerioder: [],
        } as any,
      };
    ...
    it('afgrænser TAF-perioder til erstatningsperioden', () => {
      const input: InspektionModelInput = {
        ...
        erstatningsopgoerelseValues: {
          vedroererPeriodeFra: toISODateString('2024-01-05'),
          vedroererPeriodeTil: toISODateString('2024-01-10'),
          tafPerioder: [
            {
              id: 'taf-1',
              fra: toISODateString('2024-01-01'), // Før EO-periode
              til: toISODateString('2024-01-15'), // Efter EO-periode
              loseFeriedage: '',
            },
          ],
          svieSmertePerioder: [],
      ...
      expect(result[0]?.iso).toBe(toISODateString('2024-01-05'));
      expect(result[result.length - 1]?.iso).toBe(toISODateString('2024-01-10'));
    });
  });
});
