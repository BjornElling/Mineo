...
import GreenfieldOevrigeKravTable from '../../../components/tables/GreenfieldOevrigeKravTable';
    ...
    <AppSettingsProvider>
      <RoutePathnameProvider>
        <ProductionInputRuntimeProvider binding={createProductionInputRuntimeBinding()}>
          <GreenfieldOevrigeKravTable committedRows={committedRows} />
        </ProductionInputRuntimeProvider>
      </RoutePathnameProvider>
    </AppSettingsProvider>
  </MemoryRouter>
...
describe('GreenfieldOevrigeKravTable', () => {
