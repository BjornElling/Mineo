...
// Referenceperiodens til-dato falder på første TAF-dag. Det isolerer den
// tværgående SFGG-regel om, at referenceperioden skal ligge før TAF-perioden.
const INDEPENDENT_SFGG_REFERENCE_BEFORE_TAF_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
  ...
  tafPerioder: [{
    id: 'taf-sfgg-reference-before-taf',
  ...
  sfggAnsaettelsesforhold: [{
    ansaettelsesforholdId: 'af-sfgg-reference-before-taf',
    sfggBeregningskilde: 'Ferieloven',
    sfggReferenceperiodeFra: toISODateString('2024-01-31'),
    sfggReferenceperiodeTil: toISODateString('2024-02-01'),
  ...
  loenindkomstAnsaettelsesforhold: [{
    id: 'af-sfgg-reference-before-taf',
...
describe('TD-019 – SFGG-referenceperiode før TAF uden schema-fixture', () => {
  it('afviser referenceperiodens til-dato på første TAF-dag med præcis issue-evidens', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(
      INDEPENDENT_SFGG_REFERENCE_BEFORE_TAF_VALUES,
    );
    ...
    expect(result).toEqual({
      ...
      errors: [{
        ...
        message: 'Referenceperioden skal ligge før første TAF-periode (01-02-2024)',
        severity: 'error',
      }],
    });
  });
