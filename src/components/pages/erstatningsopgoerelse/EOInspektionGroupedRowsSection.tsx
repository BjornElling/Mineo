...
const renderInspektionRow = (row: EoRowModel) => (
...
const EOInspektionGroupedRowsSection = React.memo<{
  title: string;
          ...
          {(() => {
            ...
            return (
              <>
                ...
                {section.rows.filter((row) => !isSfggPostTableRowId(row.id)).map(renderInspektionRow)}
                ...
                {sfggPostTableRows.map(renderInspektionRow)}
              </>
            );
          })()}
        </React.Fragment>
...
EOInspektionGroupedRowsSection.displayName = 'EOInspektionGroupedRowsSection';

export default EOInspektionGroupedRowsSection;
