...
- Evidensrevision: `8d1f2007` for seneste samlede releasegate og målrettede test-only batch; seneste fulde E2E er `71746917`
- Branch: `main`
...
| Aktuel fuld Vitest-retest | `npm run test` | Bestået | 814 filer, 8.965 tests bestået og ingen forventede `it.fails` på `8d1f2007` |
...
| Aktuel samlet release-gate | `npm run verify:release:core` | Bestået | Dependency-, runtime-, type-, lint-, data-, kontrakt-, lane-, ledger-, coverage- og begge build-gates bestået på `8d1f2007`; coverage 814 filer / 8.965 beståede tests / ingen forventede `it.fails` |
...
| Aktuel coverage-retest | `npm run test:coverage` | Bestået | 394 instrumenterede filer; 90,36 % statements, 81,49 % branches, 94,33 % functions, 93,15 % lines; coverage-artefakterne blev genereret under `coverage/`; `8d1f2007`, Node `v24.18.0`/Windows |
...
Den seneste samlede releasegate på `8d1f2007` er retestet grønt; den fulde E2E-suite er senest grøn
på `71746917` med 221/223. Den seneste arbejdsbatch tilføjer tre test-only facitter baseret på
`917c259c`, og både målrettet retest og samlet releasegate er grønne på `8d1f2007`. Næste arbejdsenhed
