...
// Til-datoen gør rækken ikke-tom, mens den manglende fra-dato isolerer rækkens completeness-gren.
const INDEPENDENT_TAF_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
...
describe('TD-019 – TAF-validatorens uafhængige rækkefacit', () => {
  it('rapporterer manglende fra-dato med præcis feltsti, dansk fejltekst og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_TAF_VALUES);
