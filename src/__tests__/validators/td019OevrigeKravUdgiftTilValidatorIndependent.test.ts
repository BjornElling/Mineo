...
// Rækken har dato og beløb, men mangler `udgiftTil`, så kun feltets completeness-gren rammes.
const INDEPENDENT_OEVRIGE_KRAV_UDGIFT_VALUES: ErstatningsopgoerelseValues = {
  eoNummer: undefined,
  ...
  oevrigeKravPerioder: [{
    id: 'oevrigt-krav-udgift-mangler',
...
describe('TD-019 – øvrige kravs udgift uden schema-fixture', () => {
  it('rapporterer manglende udgift med præcis feltsti, dansk besked og severity', () => {
    const result = erstatningsopgoerelseValidator.validateParsed(INDEPENDENT_OEVRIGE_KRAV_UDGIFT_VALUES);
