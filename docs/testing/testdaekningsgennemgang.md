...
| Baseline: `test:coverage`-rapport og de dækkede/udeladte mapper | `coverage/` fra auditrevisionen: 396 instrumenterede filer i `src/domain`, `src/utils`, `src/hooks` og `src/contexts`; den seneste kørsel på `d43d4837` gav 89,21 % statements, 80,45 % branches, 92,35 % functions og 92,01 % lines – 20.584 / 16.090 / 3.218 / 18.230 målte enheder. Coverage-konfigurationen omfatter ikke de øvrige produktionsfiler; de skal klassificeres i inventaret. |
...
| Felt | Udfyldes |
| --- | --- |
| Inventar-ID / gennemgået revision | `ARCH-003` / `a9423e35` |
...
- [x] `npm run test:coverage` er kørt på `d43d4837` efter auditens test- og død-kodeændringer og rapporteret med instrumenteret filmængde.
